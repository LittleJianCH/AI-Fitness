...
| Database | PostgreSQL using the selected IHP version's Hasql-based infrastructure | User/session/workout storage and IHP SQL migrations implemented; no database connection is mounted in the HTTP server yet. |
