...
| Times | RFC 3339 instants; responses emit UTC with `Z`, with fractional seconds when present. Query offsets are normalized to instants. Local-calendar/timezone settings are not modeled yet. |
